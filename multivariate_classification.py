...
df.to_csv(BASE_PATH + 'standard_scaler_results_with_ridge_and_PCA_for_classification.csv')
...
df.to_csv(BASE_PATH + 'min_max_scaler_results_with_ridge_and_PCA_for_classification.csv')