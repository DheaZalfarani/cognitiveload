...
param_grid_rf = {
	...
	'model__max_features': ['auto', 'log2', 0.3, 0.5, 0.7],
}
...
df.to_csv(BASE_PATH + 'standard_scaler_results_with_ridge_and_PCA.csv')
...
df.to_csv(BASE_PATH + 'min_max_scaler_results_with_ridge_and_PCA.csv')