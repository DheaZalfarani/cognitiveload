...
def eye_closing(experiment_Ref, routine_timer_part, win_ref, eye_closing_timer, frameTolerance,endExpNow, defaultKeyboard, base_path):
    ...
    text = visual.TextStim(win=win, name='text',
                           text='Next, please close your eyes for one minute and relax.\n\nYou will hear a sound when the minute is over.\n\nPlease do not open your eyes again until you hear the sound.\n\nPress [SPACE] when you have your eyes closed and are ready to start.',
                           font='Open Sans',
    ...
    sound_1 = sound.backend_ptb.SoundPTB('A', secs=1.0, stereo=True, hamming=True, name='sound_1')
    # sound_1.setVolume(1.0)
    # sound_1 = sound.Sound(base_path + 'needed_files\\eye_closing_sound.wav', secs=1.0, stereo=True, hamming=True,
    #                       name='sound_1')
    sound_1.setVolume(1.0)
    text_17 = visual.TextStim(win=win, name='text_17',
                              text='Please, keep your eyes closed until you hear a sound.',
                              font='Open Sans',
                              pos=(0, 0), height=letter_height_gobal, wrapWidth=None, ori=0.0,
                              color='white', colorSpace='rgb', opacity=None,
                              languageStyle='LTR',
    ...
    continueRoutine = True
    # update component parameters for each repeat
    # sound_1 = sound.Sound(base_path + 'needed_files\\eye_closing_sound.wav', secs=1.0, stereo=True, hamming=True, name='sound_1')
    #sound_1.setSound(base_path + 'needed_files\\eye_closing_sound.wav', secs=1.0, hamming=True, name='sound_1')
    ...
    eye_closing_baselineClock.reset()
    routineTimer.reset()
    frameN = -1
    ...
    while continueRoutine and routineTimer.getTime() <= eye_closing_timer:
        # get current time
